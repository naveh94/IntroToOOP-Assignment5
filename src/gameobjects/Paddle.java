...
public class Paddle implements Collidable, Sprite {
    ...
    public void moveRight() {
        if (this.topLeftCorner.getX() + this.width < this.rightBorder - this.speed) {
            Point p = new Point(this.topLeftCorner.getX() + this.speed, this.topLeftCorner.getY());
            this.topLeftCorner = p;
        } else {
            Point p = new Point(this.rightBorder - this.width, this.topLeftCorner.getY());
            this.topLeftCorner = p;
        }
    }
    ...
    public void moveLeft() {
        if (this.topLeftCorner.getX() > this.leftBorder + this.speed) {
            Point p = new Point(this.topLeftCorner.getX() - this.speed, this.topLeftCorner.getY());
            this.topLeftCorner = p;
        } else {
            Point p = new Point(this.leftBorder, this.topLeftCorner.getY());
            this.topLeftCorner = p;
        }
    }
    ...
    public void drawOn(DrawSurface board) {
        ...
        board.drawRectangle((int) topLeftCorner.getX(), (int) topLeftCorner.getY(), (int) width - 1, (int) height);
    }

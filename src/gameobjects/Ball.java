...
public class Ball implements Sprite {
    ...
    public void moveOneStep() {
        ...
        if (environment != null) {
            if (this.environment.getClosestCollision(this.getTrajectory()) != null) {
                Point colP = new Point(this.environment.getClosestCollision(this.getTrajectory()).collisionPoint());
                Collidable colOb = this.environment.getClosestCollision(getTrajectory()).collisionObject();
                ...
                Point cx, cy;
                cx = new Point(this.center.getX() + this.getVelocity().getDx(), this.center.getY());
                cy = new Point(this.center.getX(), this.center.getY() + this.getVelocity().getDy());
                if (environment.isInBlock(cx)) {
                    this.setVelocity(new Velocity(-this.getVelocity().getDx(), this.getVelocity().getDy()));
                }
                if (environment.isInBlock(cy)) {
                    this.setVelocity(new Velocity(this.getVelocity().getDx(), -this.getVelocity().getDy()));
                }
            }

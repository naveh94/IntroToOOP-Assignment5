...
public class CountdownAnimation implements Animation {
    ...
    public CountdownAnimation(double numOfSeconds, int countFrom, SpriteCollection gameScreen) {
        ...
        this.framesLeft = 60 * numOfSeconds;
    ...
    public void doOneFrame(DrawSurface board) {
        ...
        int count = (int) (framesLeft / (numOfSeconds * 60 / (countFrom + 1)));
        board.setColor(java.awt.Color.BLACK);
        board.drawText(board.getWidth() / 2 - 83, board.getHeight() / 2, "" + count + "", 300);
        board.drawText(board.getWidth() / 2 - 77, board.getHeight() / 2, "" + count + "", 300);
        board.drawText(board.getWidth() / 2 - 80, board.getHeight() / 2 + 3, "" + count + "", 300);
        board.drawText(board.getWidth() / 2 - 80, board.getHeight() / 2 - 3, "" + count + "", 300);
